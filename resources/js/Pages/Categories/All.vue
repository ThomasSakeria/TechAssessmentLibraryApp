...
<template>
    <AdminDashboard>
            ...
            <div class=" max-w-7xl mx-auto  border border-gray-500 py-2">
                ...
                <table v-if="categories.length > 0" class="items-center bg-transparent w-full border-collapse">
                <thead>
                <tr>
                ...
                <div v-else class="bg-red-100 border border-red-400 p-3 rounded-lg text-red-800 text-left mgt-5"> There are no categories to display!! Add one to List..</div>
            ...
            <Modal :show="acting" :closeable="true" @close="acting=false">
                ...
                <h2 class="text-gray-900 text-lg mb-1 font-medium title-font">Add New Category</h2>
                ...
                <div class="relative mb-2">
                    ...
                    <textarea id="description" name="description" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out" required
